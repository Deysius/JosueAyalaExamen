...
namespace JosueAyalaExamen.Controllers
{
    public class ReservasController : Controller
    {
        ...
        public ReservasController(JosueAyalaExamenContextSQLServer context)
        {
            _context = context;
        }
        ...
        {
            var josueAyalaExamenContextSQLServer = _context.Reserva.Include(r => r.Cliente);
            return View(await josueAyalaExamenContextSQLServer.ToListAsync());
        }
